...
public static void main(String[] args) {
		...
		System.out.println(temp + tempType + " is " + doConversion(temp, tempType) + ((tempType.equalsIgnoreCase("C")) ? "F":"C") + ".");
		
		
	}
	
	public static double doConversion(double temp, String tempType){
			return (tempType.equalsIgnoreCase("C")) ?  (temp * 1.8 + 32) : (temp-32)/1.8;
	}
}
